...
\begin{itemize}
    ...
    \lstinputlisting[linerange={119-149}, firstnumber=119]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    \lstinputlisting[linerange={159-167}, firstnumber=159]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    \lstinputlisting[linerange={195-216}, firstnumber=195]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    \lstinputlisting[linerange={218-225}, firstnumber=218]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    \lstinputlisting[linerange={227-233}, firstnumber=227]{../src/main/java/vs/chat/client/ClientApiImpl.java}

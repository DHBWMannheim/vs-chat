...
\begin{itemize}
    ...
    \end{enumerate}
    \lstinputlisting[linerange={326-356}, firstnumber=326]{../src/main/java/vs/chat/client/ClientApiImpl.java}//TODO
    ...
    \lstinputlisting[linerange={358-403}, firstnumber=358]{../src/main/java/vs/chat/client/ClientApiImpl.java}//TODO
    ...
    \lstinputlisting[linerange={405-419}, firstnumber=405]{../src/main/java/vs/chat/client/ClientApiImpl.java}//TODO
    ...
    heruntergefahren.\\
    \lstinputlisting[linerange={430-438}, firstnumber=430]{../src/main/java/vs/chat/client/ClientApiImpl.java}//TODO
Verwendung von Emojis: \\\\
	Wie bereits in der Doku erwähnt nutzen wir für die Darstellung von Emojis Unicode.
	\lstinputlisting[linerange={621-631}, firstnumber = 621]{../src/main/java/vs/chat/client/UI/ClientGUI.java}//TODO
	...
	\lstinputlisting[linerange={89-109}, firstnumber = 89]{../src/main/java/vs/chat/client/UI/ClientGUI.java}//TODO

...
\begin{itemize}
    ...
    \end{enumerate}
    \lstinputlisting[linerange={262-292}, firstnumber=262]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    Handelt es sich um ein KeyExchangePacket wird ... \\
    // TODO
    \lstinputlisting[linerange={294-339}, firstnumber=294]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    \lstinputlisting[linerange={341-355}, firstnumber=341]{../src/main/java/vs/chat/client/ClientApiImpl.java}
    ...
    heruntergefahren.\\
    \lstinputlisting[linerange={356-358}, firstnumber=356]{../src/main/java/vs/chat/client/ClientApiImpl.java}
